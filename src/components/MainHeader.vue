                      ...
                      <ul class="quicky-dropdown">
                        ...
                        <li class="position-relative">
                          ...
                          <ul class="quicky-dropdown quicky-submenu">
                            <li>
                              <a href="blog-left-sidebar.html">学术</a>
                            </li>
                          </ul>
                        </li>
                      </ul>
          ...
          <ul class="minicart-list" v-for="(item, index) in cartlist"
            ...
            <li
              ...
              <div class="product-item_content">
                <a class="product-item_title" href="javascript:;"
                  >{{item.goodsName}}</a
                >
                <!-- 产品价格 -->
                <span class="product-item_quantity">{{item.goodsPrice}}</span>
              </div>
            </li>
          </ul>
        </div>
        ...
        <div class="container">
          ...
          <div class="offcanvas-search">
            <form  class="hm-searchbox">
              <input type="text" placeholder="商品模糊查询" />
